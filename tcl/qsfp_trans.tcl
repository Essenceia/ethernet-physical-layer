...
# create the system "qsfp_trans"
proc do_create_qsfp_trans {} {
	# create the system
	create_system qsfp_trans
...
<bonusData>
 <element __value="xcvr_native_a10_0">
  <datum __value="_sortIndex" value="0" type="int" />
	...
	set_module_property FILE {qsfp_trans.ip}
	set_module_property GENERATION_ID {0x00000000}
	set_module_property NAME {qsfp_trans}

	# save the system
	sync_sysinfo_parameters
	save_system qsfp_trans
}
